...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax_auth_object = {"ajaxurl":"https:\/\/www.urbanui.com\/wp-admin\/admin-ajax.php","redirecturl":"\/gleam\/pages\/path-to\/node_modules\/chartist\/dist\/chartist.min.js","loadingmessage":"Please wait..."};
/* ]]> */
</script>
...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
  ...
  display: none;
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="53d703278c" /><input type="hidden" name="_wp_http_referer" value="/gleam/pages/path-to/node_modules/chartist/dist/chartist.min.js" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="4dabf41730" /><input type="hidden" name="_wp_http_referer" value="/gleam/pages/path-to/node_modules/chartist/dist/chartist.min.js" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="9d4564bf64" /><input type="hidden" name="_wp_http_referer" value="/gleam/pages/path-to/node_modules/chartist/dist/chartist.min.js" />  
